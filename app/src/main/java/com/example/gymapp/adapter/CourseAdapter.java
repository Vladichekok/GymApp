...
import com.example.gymapp.CoursePage;
...
public class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.CourseViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CourseViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation((Activity) context, new Pair<>(holder.courseImage, "courseImage"));
    ...
    public static final class CourseViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView courseTitle, courseDate, courseLvl;
